...
# or subset by smaller list
#@ targetgene <- c("AGRP","BMT2")
...
counts.by.samling.date.male <- counts.LOG[,c("MN21818Li","MB22918Li","MB22918Li2","MB25918Li","MB25918Li2","MB021018Li","MB021018Li2","MB041018Li",
                                             ...
                                             "FN21818Li","FN21818Li2","FB22918Li","FB25918Li","FB021018Li2",
...
# LIVER
if(the.tissue == "liver")
{ counts.by.samling.date.male <- counts.LOG[,c(
                                               "FN21818Li","FN21818Li2","FB22918Li","FB25918Li","FB021018Li2")] }
# SKELETAL MUSCLE
...
heatmap.3((counts.df2), col=cols, scale="row", trace="none",density.info="none", dendrogram="none",Colv=FALSE, Rowv=TRUE, key=TRUE,cexRow=0.5,breaks=seq(-3,3,6/256)   )
dev.off()